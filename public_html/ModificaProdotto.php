...
if (!$login) {
    ...
    $descr      = "Pagina che permette di modificare i dati del prodotto per correggere le sue informazioni";
    $keywords = "Modifica, Gestione, Prodotto, Nome, Marca, Tipo, Quantità, Prezzo, Vendita, Rivendita";
