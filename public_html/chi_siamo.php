...
<p class=\"center\">Il suo destino era proprio scritto nei capelli. Anna Cortivo nasce figlio d'arte. Oggi Anna &egrave; tra i pi&ugrave; affermati <span xml:lang=\"en\">hairdresser</span> della provincia, con base a Montecchio Maggiore. La sua particolare visione creativa si distingue innanzitutto per la cura oltremodo personale, <span xml:lang=\"en\">customized</span>, totalmente indipendente e immediata del suo approccio. Vicepresidente del consorzio di Vicenza Parrucchieri, Anna ha seguito sulle passerelle italiane grandi stilisti internazionali, imponendosi in vari <span xml:lang=\"en\">hair show</span> internazionali. Vicintrice di un concorso di <span xml:lang=\"en\">concept moda</span> a Milano. La successiva tappa professionale lo vede dedicarsi al 100% sue clienti.</p>
<p class=\"center\">La filosofia dell'<span xml:lang=\"en\">hair styling</span> AnnaRosa si sviluppa intorno a una serie di concetti e attuazioni fondamentali. Si tratta di un cocktail speciale, unico, nutrito di estro, fantasia, di un gusto oltremodo sicuro, versatile e caratterizzato da una padronanza tecnica eccezionale e in continuo aggiornamento. Alla spiccata e fluida geometria delle forme, a una rigorosa ricerca sulle proporzioni e a una raffinata e insieme basica armonia con lo stile personale di ognuno, Armano accosta il potenziamento delle attitudini e il profondo rispetto per la natura di ogni capello, inteso come materiale prezioso da valorizzare.</p>";
echo $to_print;
content_end();
page_end();
?>
