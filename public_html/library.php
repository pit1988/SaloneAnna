...
<li><a href="img_db.php" id="real" class='.(($num == 1) ? ("vnav"):("nav")).' accesskey="c" tabindex="11">Inserisci Foto</a></li>
<li><a href="Clienti.php" id="real" class='.(($num == 2) ? ("vnav"):("nav")).' accesskey="c" tabindex="11">Clienti</a></li>
<li><a href="Prodotti.php" id="vend" class='.(($num == 3) ? ("vnav"):("nav")).' accesskey="p" tabindex="12">Prodotti </a></li>
<li><a href="Appuntamenti.php" id="cont" class='.(($num == 4) ? ("vnav"):("nav")).' accesskey="a" tabindex="13">Appuntamenti</a></li>
</ul>
</div>
';
    echo $to_print;
