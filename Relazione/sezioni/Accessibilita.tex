\section{Accessibilità}{
	...
	\subsection{Combinazione dei colori}{
		...
		Di seguito vengono riportati i risultati ottenuti sulla sulla pagina relativa ai prezzi, che contiene molti elementi utilizzati anche nelle altre pagine.
%		\newpage
		\begin{figure}[H]
%			\centering
			...
			\begin{subfigure}[b]{0.5\textwidth}
				...
				\label{Pagina vista da un protranope}
			\end{subfigure}
			\begin{subfigure}[b]{0.5\textwidth}
			\includegraphics[width=\textwidth]{\docsImg Tritan.png}
				%\vspace{-40pt}
				\caption{Home Page vista da un tritranope}
				\label{Pagina vista da un tritranope}
			\end{subfigure}
			\caption{Pagina vista da persone con problemi nel distinguere i colori}
			\label{fig: Pagina vista da persone con problemi nel distinguere i colori}
		\end{figure}
