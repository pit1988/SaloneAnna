...
//assegno il codice app alla sessione
$_SESSION['CodApp']=$CodApp;
...
echo "<h3>Appuntamento #$CodApp di $nome $cognome :</h3><br>";
	...
	;
		...
		$queryp = "SELECT p.CodProdotto, p.Nome FROM Prodotti p WHERE p.Tipo='In Salon Service' AND p.Quantita is not NULL AND p.Quantita>0 ";
